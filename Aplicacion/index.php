    ...
    <td width="800" valign="top">
		<table width="670" border="0" cellspacing="0" cellpadding="0">
		  <tr> 
			...
			<td width="660" valign="top" class="titulo"><?=pal('presentacion', $idioma)?></td>
		  </tr>
		  <tr> 
			<td width="10">&nbsp;</td>
			
          <td width="660"><br><p><?=pal('resumenProyecto',$idioma)?></p><p><?=pal('realizadoPor',$idioma)?>:</p>
            <ul>
              <li><u>Sixto Sua&ntilde;a Moreno</u> (I.T. Inform&aacute;tica de Gesti&oacute;n)</li>
              <li><u>Jos&eacute; Mar&iacute;a Talavera Calzado</u> (I.T. Inform&aacute;tica 
                de Gesti&oacute;n)</li>
            </ul>
              Escuela T&eacute;cnica Superior de Ingenier&iacute;a Inform&aacute;tica 
            (Universidad de Sevilla). 2002-2003.<br></td>
		  </tr>
		</table>
