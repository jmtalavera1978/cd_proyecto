    ...
    <td width="800" valign="top">
		<table width="670" border="0" cellspacing="0" cellpadding="0">
		  <tr> 
			...
			<td width="660" valign="top" class="titulo"><?=pal('forosEjemplo', $idioma)?></td>
		  </tr>
		  <tr> 
			<td width="10">&nbsp;</td>
			
            <td width="670"><br>
				<a href="foroPublico/index.php" target="_blank"><?=pal('foroPublico', $idioma)?></a><br><br>
				<a href="foroProtegido/index.php" target="_blank"><?=pal('foroProtegido', $idioma)?></a><br><br>
				<a href="foroPrivado/index.php" target="_blank"><?=pal('foroPrivado', $idioma)?></a><br><br>
				<a href="foroMultiple/index.php" target="_blank"><?=pal('foroMultiple', $idioma)?></a>
			</td>
		  </tr>
		</table>
