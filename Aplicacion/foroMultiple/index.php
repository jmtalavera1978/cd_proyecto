		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<?php if ($permitir_iconos_como_enlaces) { ?>
					<td class="encabezado_de_foro" align="right"><a href="admin/"><img src="img/admin.gif" alt="Administrador"></a></td>
				<?php } else { ?>
					<td class="encabezado_de_foro" align="right"><a href="admin/">Administrador</a></td>
				<?php } ?>
...
?>
	...
	<tr><td class="encabezado_de_foro">
        ...
        <td align="left" valign="middle" class="campo">Bienvenido usuario <a href="usuarios.php"><?=$login_usuario?></a>, todos los recursos han sido activados.</td>
	...
	<tr><td class="encabezado_de_temas">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<?php if ($permitir_iconos_como_enlaces) { ?>
					<td align="right"><a href="tema.php"><img src="img/nuevo.gif" alt="Nuevo tema p&uacute;blico" width="20" height="20"></a></td>
				<?php } else { ?>
...
<?php
		//Crea la fila con la lista de foros públicos
		listar_foros(false);
?>
	<tr><td>&nbsp;</td></tr>
	<tr><td class="encabezado_de_temas">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<?php if (@session_is_registered('login_usuario')) {
						if ($permitir_iconos_como_enlaces) { ?>
					<td align="right"><a href="tema_protegido.php"><img src="img/nuevo.gif" alt="Nuevo tema protegido" width="20" height="20"></a></td>
				<?php 	} else { ?>
					<td align="right"><a href="tema_protegido.php">Nuevo tema</a></td>
				<?php 	}
					  } ?>
			</tr>
		</table>
	...
	<tr><td class="encabezado_de_temas">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<?php if (@session_is_registered('login_usuario')) {
						if ($permitir_iconos_como_enlaces) { ?>
					<td align="right"><a href="tema_privado.php"><img src="img/nuevo.gif" alt="Nuevo tema privado" width="20" height="20"></a></td>
				<?php 	} else { ?>
					<td align="right"><a href="tema_privado.php">Nuevo tema</a></td>
				<?php 	}
					  } ?>
			</tr>
		</table>
