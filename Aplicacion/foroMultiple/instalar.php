<?php 
	...
	imprime_encabezado_de_pagina('Instalaci&oacute;n del foro', '', false);
	...
	//CREACION DE LA TABLA DE 'TEMASPRIVADOS' DEL FORO
	$sql = "CREATE TABLE temas_privados (
				  id_tema int(7) unsigned NOT NULL auto_increment,
				  titulo_tema varchar(255) NOT NULL default '',
				  descripcion varchar(255) NOT NULL default '',
				  visible varchar(2) NOT NULL default 'NO',
				  PRIMARY KEY  (id_tema),
				  UNIQUE KEY id_tema (id_tema,titulo_tema),
				  KEY id_tema_2 (id_tema))";
	if (consulta($sql))
		echo "<tr><td class=\"tabla_de_temas\">La tabla TEMASPRIVADOS se ha creado con &eacute;xito.</td></tr>";
	else {
		echo "<tr><td class=\"tabla_de_temas\">ERROR al crear la tabla TEMASPRIVADOS.</td></tr>";
		echo "<tr><td class=\"fila_de_tabla\">".nl2br(htmlentities($sql))."</td></tr>";
	}
	
	//CREACION DE LA TABLA DE 'TEMASPROTEGIDOS' DEL FORO
	$sql = "CREATE TABLE temas_protegidos (
				  id_tema int(7) unsigned NOT NULL auto_increment,
				  titulo_tema varchar(255) NOT NULL default '',
				  descripcion varchar(255) NOT NULL default '',
				  PRIMARY KEY  (id_tema),
				  ...
				  KEY id_tema_2 (id_tema))";
	if (consulta($sql))
		echo "<tr><td class=\"tabla_de_temas\">La tabla TEMASPROTEGIDOS se ha creado con &eacute;xito.</td></tr>";
	else {
		echo "<tr><td class=\"tabla_de_temas\">ERROR al crear la tabla TEMASPROTEGIDOS.</td></tr>";
		echo "<tr><td class=\"fila_de_tabla\">".nl2br(htmlentities($sql))."</td></tr>";
	}
	...
	//CREACIÓN DE LA TABLA DE 'MENSAJES_PROTEGIDOS'
	$sql = "CREATE TABLE mensajes_protegidos (
				  id_mensaje int(11) unsigned NOT NULL auto_increment,
				  id_tema int(7) unsigned NOT NULL default '0',
				  id_padre int(11) unsigned NOT NULL default '0',
				  asunto varchar(255) NOT NULL default '',
				  ...
				  num_respuestas int(7) unsigned NOT NULL default '0',
				  fecha_ultima_respuesta datetime NOT NULL default '0000-00-00 00:00:00',
				  autor_host varchar(255) NOT NULL default '',";
	$sql .= "	  lecturas int(7) unsigned NOT NULL default '0',";
	if ($imagen_mensaje) {
		$sql .= " imagen_data longblob NOT NULL,
				  imagen_name varchar(255) NOT NULL default '',
	...
	$sql .= "	  PRIMARY KEY  (id_mensaje),
				  ...
				  KEY id_mensaje_2 (id_mensaje))";
	if (consulta($sql))
		echo "<tr><td class=\"tabla_de_temas\">La tabla MENSAJES_PROTEGIDOS se ha creado con &eacute;xito.</td></tr>";
	else {
		echo "<tr><td class=\"tabla_de_temas\">ERROR al crear la tabla MENSAJES_PROTEGIDOS.</td></tr>";
		echo "<tr><td class=\"fila_de_tabla\">".nl2br(htmlentities($sql))."</td></tr>";
	}
	
	//CREACIÓN DE LA TABLA DE 'MENSAJES_PRIVADOS'
	$sql = "CREATE TABLE mensajes_privados (
				  id_mensaje int(11) unsigned NOT NULL auto_increment,
				  id_tema int(7) unsigned NOT NULL default '0',
				  id_padre int(11) unsigned NOT NULL default '0',
				  asunto varchar(255) NOT NULL default '',
				  ...
				  fecha_ultima_respuesta datetime NOT NULL default '0000-00-00 00:00:00',
				  autor_host varchar(255) NOT NULL default '',
				  lecturas int(7) unsigned NOT NULL default '0',
				  visible varchar(2) NOT NULL default 'NO',";
	if ($imagen_mensaje) {
		$sql .= " imagen_data longblob NOT NULL,
				  imagen_name varchar(255) NOT NULL default '',
	...
	$sql .= "	  PRIMARY KEY  (id_mensaje),
				  ...
				  KEY id_mensaje_2 (id_mensaje))";
	if (consulta($sql))
		echo "<tr><td class=\"tabla_de_temas\">La tabla MENSAJES_PRIVADOS se ha creado con &eacute;xito.</td></tr>";
	else {
		echo "<tr><td class=\"tabla_de_temas\">ERROR al crear la tabla MENSAJES_PRIVADOS.</td></tr>";
		echo "<tr><td class=\"fila_de_tabla\">".nl2br(htmlentities($sql))."</td></tr>";
	}
	...
	$sql = "CREATE TABLE usuarios (
				  ...
				  login varchar(12) NOT NULL,"; //El login tendrá entre 4 y 12 caracteres
	if ($autor_mensaje) {
		$sql .= " nombre_usuario varchar(255) NOT NULL,
				  apellidos_usuario varchar(255) NOT NULL,";
	}
	if ($email_mensaje) {
		$sql .= " email_usuario varchar(255) NOT NULL,";
	}
	if ($web_mensaje){
		$sql .= " web_usuario varchar(255),";
	}
	$sql .= "	  tiene_permiso varchar(2) NOT NULL default 'NO',
	...
	if ($email_mensaje) {
		$sql .= " 				UNIQUE KEY email_usuario (email_usuario),";
	}
				  
	$sql .= "			  UNIQUE KEY login (login))"; //El password tendrá mas de 4 caracteres
	if (consulta($sql))
		echo "<tr><td class=\"tabla_de_temas\">La tabla USUARIOS se ha creado con &eacute;xito.</td></tr>";
	else {
		echo "<tr><td class=\"tabla_de_temas\">ERROR al crear la tabla USUARIOS.</td></tr>";
		echo "<tr><td class=\"fila_de_tabla\">".nl2br(htmlentities($sql))."</td></tr>";
	}
