<?php
	...
	if (@$HTTP_POST_VARS) {
		...
		$sql = "INSERT INTO temas_protegidos(titulo_tema, descripcion) VALUES ('$tema', '$descripcion')";
		consulta ($sql);
...
//-->
	...
	imprime_encabezado_de_pagina("Escribir un nuevo tema protegido en el foro", $javascript, false);
?>
      ...
      <td class="encabezado_de_foro"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td class="encabezado_de_foro">
              ESCRIBIR UN NUEVO TEMA PROTEGIDO
            </td>
