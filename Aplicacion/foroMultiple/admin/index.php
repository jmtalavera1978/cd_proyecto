<?php
	...
	if (strstr(@$HTTP_GET_VARS['borrar'],'foro') && !@$HTTP_GET_VARS['afirmar']) {
		echo "<script language='JavaScript'>\n";
      	echo "	if (confirm('¿Está seguro de que quiere borrar el foro ";
	...
	//Creación de la página del administrador
	...
	//============================================
	//PRESENTACION DE LAS FUNCIONES DE ESTA PÁGINA
	//============================================
...
<?php
		...
		if (@$gets['id_tema'] || !$permitir_varios_foros) { //FOROS
			...
			//Presentamos la lista de mensajes según el tipo de foro
