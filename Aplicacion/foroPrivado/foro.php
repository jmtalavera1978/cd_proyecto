...
<?php
	...
	$sql = "SELECT id_mensaje, asunto, usuario, fecha_publicacion, lecturas, num_respuestas, fecha_ultima_respuesta FROM mensajes WHERE id_tema='$id_tema' AND id_padre='0'";
	if ($permitir_moderacion_foro) $sql .= " AND visible='SI'";
