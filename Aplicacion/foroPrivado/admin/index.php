<?php
	...
	if (@$HTTP_GET_VARS['publicar']  && $permitir_moderacion_foro) {
		if (consulta ("UPDATE temas SET visible='".@$HTTP_GET_VARS['publicar']."' WHERE id_tema='".@$HTTP_GET_VARS['id']."'"))
	...
	if (@$HTTP_GET_VARS['publicarM']  && $permitir_moderacion_foro) {
		if (consulta ("UPDATE mensajes SET visible='".@$HTTP_GET_VARS['publicarM']."' WHERE id_tema='".@$HTTP_GET_VARS['id_tema']."' AND id_mensaje=".@$HTTP_GET_VARS['id']))
